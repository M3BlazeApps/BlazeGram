...
class UserPreferences(context: Context) {
    ...
    var convertToMp4: Boolean
        get() = prefs.getBoolean(KEY_CONVERT_MP4, true)
        set(value) = prefs.edit().putBoolean(KEY_CONVERT_MP4, value).apply()

    var fetchItunesMetadata: Boolean
        get() = prefs.getBoolean(KEY_ITUNES_METADATA, true)
        set(value) = prefs.edit().putBoolean(KEY_ITUNES_METADATA, value).apply()
    ...
    companion object {
        ...
        private const val KEY_CONVERT_MP4 = "convert_mp4"
        private const val KEY_ITUNES_METADATA = "itunes_metadata"
    }
}
